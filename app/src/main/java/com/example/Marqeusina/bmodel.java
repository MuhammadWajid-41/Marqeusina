...
{
    //String name,email;
    String name, Date, guests_coming, purl, package_name, event_time, event_type, package_price, token_payed;


    public bmodel() {
    }

    public bmodel(String name, String Date, String guests_coming, String purl, String package_name, String event_time, String event_type, String package_price, String token_payed) {
        this.name = name;
        this.Date = Date;
