...
public class Bookings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter=new bmyadapter(datalist);
                            ...
                            .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>()
                            {
                                ...
                                public void onSuccess(QuerySnapshot queryDocumentSnapshots)
                                {
                                    ...
                                    for (DocumentSnapshot d : list)
                                    {
                                        ...
                                        {
                                            bmodel obj = d.toObject(bmodel.class);
                                            datalist.add(obj);
                                        }
                                       // else
                                       // {
                    ...
                    dbroot.collection("Bookings").document(mEmail).collection("booked_users")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>()
                            {
                                ...
                                public void onSuccess(QuerySnapshot queryDocumentSnapshots)
                                {
                                    ...
                                    if(datalist.isEmpty())
                                    {
                                        Toasty.error(getContext(),"There are currently no pending Bookings with provided DATE!",Toasty.LENGTH_LONG).show();
                                    }
                                    adapter.notifyDataSetChanged();
                                }
                            });
                            ...
                            .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        {
                                            Toasty.info(getContext(), "No such bookings exists!", Toast.LENGTH_SHORT).show();
                    ...
                    /*dbroot.collection("Bookings").document(mEmail).collection("booked_users")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>()
                            {
                                ...
                                public void onSuccess(QuerySnapshot queryDocumentSnapshots)
                                {
                                    ...
                                    for (DocumentSnapshot d : list)
                                    {
                                        if (d.getString("name") != null && d.getString("status").equals("booked"))
                                        {
                                            bmodel obj = d.toObject(bmodel.class);
                                            datalist.add(obj);
                                        }
