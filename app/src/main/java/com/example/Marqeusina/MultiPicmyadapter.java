...
public class MultiPicmyadapter extends RecyclerView.Adapter<MultiPicmyadapter.myviewholder>
{
    List<String> files,status;

    public MultiPicmyadapter(List<String> files, List<String> status) {
        this.files = files;
        this.status = status;
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.multi_singlerow,parent,false);
